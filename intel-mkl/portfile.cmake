...
elseif(VCPKG_TARGET_IS_OSX)
  ...
  set(pkgconfig_fix "mac/compiler")
elseif(VCPKG_TARGET_IS_LINUX)
  ...
  set(pkgconfig_fix "linux/compiler")
endif()
...
")
    ...
    if(threading STREQUAL "intel_thread")
      ...
      file(COPY_FILE "${compiler_dir}/lib/pkgconfig/openmp.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libiomp5.pc")
      vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libiomp5.pc" "/${pkgconfig_fix}" "")
      vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libiomp5.pc" "-L\${libdir}" "-L\${libdir} -Wl,-rpath='\${libdir}'")
      vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/${main_pc_file}" "openmp" "libiomp5")
    endif()
endif()
