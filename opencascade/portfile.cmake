...
set(config_file ${CURRENT_PACKAGES_DIR}/share/${PORT}/OpenCASCADEConfig.cmake)
file(READ "${config_file}" contents)
string(REGEX REPLACE "set \\\(OpenCASCADE_C_FLAGS [^\n]+" "set (OpenCASCADE_C_FLAGS \"\")" contents "${contents}")
string(REGEX REPLACE "set \\\(OpenCASCADE_CXX_FLAGS [^\n]+" "set (OpenCASCADE_CXX_FLAGS \"\")" contents "${contents}")
string(REGEX REPLACE "set \\\(OpenCASCADE_LINKER_FLAGS [^\n]+" "set (OpenCASCADE_LINKER_FLAGS \"\")" contents "${contents}")
